...
def PNASNetImageNet():
    ...
    add_cell(g, 'cell_0', stride=2, in_channels=128, out_channels=256, from_='cbr')
    ...
    add_cell(g, 'cell_4', stride=2, in_channels=256, out_channels=512, from_='cell_3.end')
